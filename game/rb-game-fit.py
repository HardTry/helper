...
if __name__ == "__main__":
    ...
    if (len(sys.argv) != 4):
        print 'Usage: python rb-game-fit.py <instrument> <r|the trade day> <data file path>\n' \
              ...
              '           python rb-game-fit.py rb888 r /data/sean/10s_candle_bindata\n' \
              '         get one day data\n' \
              '           python rb-game-fit.py rb888 20150601 /data/sean/10s_candle_bindata\n\n' \
              '  Keyboard:                              \n' \
              '      i:	pause/continue                  \n' \
              '      a: open long                       \n' \
              '      b:	open short                      \n' \
