...
class DataMath:
    ...
    def do_math(self, cp):
        # print cp, self.all_len, cp - self.data_len, len(self.all_data[cp - self.data_len: cp])
...
if __name__ == "__main__":
    ...
    if (len(sys.argv) != 3):
        print 'Usage: python rb-3period-game.py <r|the trade day> <data file path>\n'\
              ...
              '           python rb-3period-game.py r /data/sean/20170508/bindata/rb888\n'\
              '         get one day data\n'\
              '           python rb-3period-game.py 20150601 /data/sean/20170508/bindata/rb888\n\n'\
              '  Keyboard:                                \n'\
              '      i:	pause/continue                    \n'\
              '      a: 	open long                     \n'\
              '      b:	open short                        \n'\
