...
class FigureThread(threading.Thread):
    ...
    def run(self):
        ani_lines1 = animation2.SubplotAnimation(self.m12, self.trade, self.params, 0, self.save_pos)
...
if __name__ == "__main__":
    ...
    t_figure = FigureThread(m12, params, save_pos, g_trader)
    t_figure.start()
